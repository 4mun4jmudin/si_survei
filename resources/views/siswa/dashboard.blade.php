            ...
            <div class="mb-8 relative overflow-hidden rounded-2xl bg-gradient-to-r from-amber-500 to-orange-500 p-[1px]">
                <div class="bg-white/95 backdrop-blur-sm rounded-[15px] px-5 py-4 flex items-center gap-4">
                    ...
                    <div class="flex-1 min-w-0">
                        ...
                        <p class="text-xs text-slate-500 mt-0.5">Silakan lengkapi survei aktif kamu</p>
                    </div>
            ...
            <div class="mb-10 relative overflow-hidden rounded-3xl bg-gradient-to-br from-indigo-600 via-indigo-700 to-blue-800 p-8 sm:p-10 text-white">
                ...
                <div class="relative z-10 flex flex-col sm:flex-row sm:items-center justify-between gap-6">
                    <div>
                        ...
                        <p class="text-indigo-200 mt-2 text-sm sm:text-base max-w-md">Suaramu sangat berarti untuk kemajuan sekolah kita.</p>
                    </div>
                        ...
                        <div class="p-6">
                            <div class="flex items-start gap-4">
                                ...
                                <div class="flex-1 min-w-0">
                                    ...
                                    <p class="text-sm text-slate-400 mt-1 line-clamp-1">Berikan penilaian objektif untuk periode ini.</p>
                                </div>
                            </div>
                            ...
                            <div class="mt-5 flex items-center justify-between">
                                ...
                                <a href="{{ route('siswa.survei.detail', $kuesioner) }}" class="inline-flex items-center gap-2 px-5 py-2.5 bg-indigo-600 text-white text-xs font-bold rounded-xl hover:bg-indigo-700 transition shadow-sm hover:shadow-indigo-200 group-hover:scale-[1.02]">
                                    Mulai
                ...
                <div class="lg:col-span-2 space-y-6">
                    ...
                    <div class="relative overflow-hidden rounded-2xl bg-gradient-to-br from-slate-800 to-slate-900 p-6 text-white">
                        ...
                        <div class="relative z-10">
                            ...
                            <h3 class="text-base font-bold mb-2">Pentingnya Suaramu</h3>
                            <p class="text-sm text-slate-300 leading-relaxed">Setiap penilaian yang kamu berikan membantu sekolah mengidentifikasi hal-hal yang perlu diperbaiki demi kenyamanan belajarmu.</p>
                        </div>
                    </div>

                    {{-- Quick Link Profil --}}
                    <a href="{{ route('siswa.profil') }}" class="flex items-center gap-3 bg-white/80 backdrop-blur-sm rounded-2xl border border-white shadow-sm p-4 hover:shadow-md hover:border-indigo-200 transition-all group">
                        ...
                        <div class="flex-1 min-w-0">
                            ...
                            <p class="text-xs text-slate-400">Ubah password akun kamu</p>
                        </div>
