...
<head>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .completion-title {
            font-size: 1.75rem; font-weight: 800; color: var(--slate-900); margin-bottom: 0.5rem;
        }
        .completion-desc {
            font-size: 0.95rem; color: var(--slate-500); max-width: 360px; line-height: 1.6;
        }
        ...
        <div class="survey-container">
            <form action="{{ route('siswa.survei.store', $kuesioner) }}" method="POST" id="surveyForm">
                ...
                <div class="completion-screen" id="completionScreen">
                    ...
                    <p class="completion-desc">Terima kasih atas partisipasimu. Klik tombol di bawah untuk mengirim semua jawabanmu.</p>
                </div>
            </form>
        </div>
    </div>
    ...
    (function() {
        ...
        document.querySelectorAll('.option-card').forEach(card => {
            card.addEventListener('click', function() {
                ...
                // Deselect siblings
                slide.querySelectorAll('.option-card').forEach(c => {
